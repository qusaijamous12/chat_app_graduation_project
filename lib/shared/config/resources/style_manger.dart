...
TextStyle _getMyTextStyle({required Color color,required double fontSize,required String fontFamily,required FontWeight weight}){
...
TextStyle getMyRegulerTextStyle({required Color color,double fontSize=FontSize.s14}){
  return _getMyTextStyle(color: color, fontSize:fontSize , fontFamily: FontFamily.fontFamily, weight: TextFontWeight.regulerWeight);
}
